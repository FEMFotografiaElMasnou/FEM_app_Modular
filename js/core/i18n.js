...
export const TRANSLATIONS = {
  ca: {
    ...
    nav_class_general: 'Classificació general',
    nav_class_reptes: 'Classificació reptes',
  ...
  es: {
    ...
    nav_class_general: 'Clasificación general',
    nav_class_reptes: 'Clasificación retos',
